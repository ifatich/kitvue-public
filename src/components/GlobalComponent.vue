            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <Button class="me-2 mb-2" type="primary" size="md" label="Button Primary" />
                            <Button class="me-2 mb-2" type="secondary" size="md" label="Button Seccondary" />
                            <Button class="me-2 mb-2" type="neutral" size="md" label="Button Neutral" />
                            <Button class="me-2 mb-2" type="tertiary" size="md" label="Button Tertiary" />
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h5>Button</h5>
                            <p class="mb-0"><code>&lt;Alert color="primary" label="md" &gt;</code></p>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <Breadcrumb
                                        :items="['Beranda 1', 'Produk 2', 'Layanan Jasa 3', 'Safe Deposit Box 4']" />
                                </div>
                            </div>
                        </div>
                            ...
                            <ModalComponent title="Test Modal" btnValue="Test Modal" class="mb-2">
                                <template v-slot:body>
                                    <div class="text-center">
                                        <svg width="328" height="164" viewBox="0 0 328 164" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#BBF0D3" />
                                            <mask id="mask0_898_7325" style="mask-type:luminance"
                                                maskUnits="userSpaceOnUse" x="0" y="0" width="328" height="164">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M23.2189 161.504C33.6809 163.667 265.053 165.826 301.876 161.504C312.777 160.224 321.503 148.276 322.776 146.203C330.736 133.238 327.751 53.2794 325.761 26.266C324.69 11.7278 309.838 5.19571 302.871 3.03482C289.548 -1.09779 53.2799 -1.26366 22.2229 4.11573C8.32787 6.52168 3.29087 17.8712 2.29087 24.1796C-0.0421274 38.8847 -1.42113 129.331 2.31887 141.514C5.30487 151.239 12.7689 159.343 23.2189 161.504Z"
                                                    fill="white" />
                                            </mask>
                                            <g mask="url(#mask0_898_7325)">
                                                <path d="M0 164H328V6.10352e-05H0V164Z" fill="#F8FBEA" />
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    ...
                                                    fill="#84D7CC" />
                                                <path d="M42 87.0001C42 87.0001 54.1483 58.8298 62 25.0001"
                                                    stroke="white" stroke-width="0.78057" stroke-linecap="round"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    ...
                                                    fill="#B3EC91" />
                                                <path d="M32 106C32 106 19.852 76.4664 12 41.0001" stroke="white"
                                                    stroke-width="0.63014" stroke-linecap="round" />
                                                <path d="M18 62.0001L26 52.0001" stroke="white" stroke-width="0.63014"
                                                    stroke-linecap="round" />
                                                <path d="M0 77.0001L328 10.0001V192.5H0L0 77.0001Z" fill="#CFE163" />
                                                <path d="M0 77.0001L328 10.0001L328 125.5L0 192.5L0 77.0001Z"
                                                    fill="#E5EFAC" />
                                                <rect x="48.1437" y="100.301" width="100" height="45.4545" rx="10.9091"
                                                    transform="rotate(-12.1032 48.1437 100.301)" fill="#00883E" />
                                                <rect x="47" y="94.9673" width="100" height="45.4545" rx="10.9091"
                                                    transform="rotate(-12.1032 47 94.9673)" fill="#00AB4E" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    fill="white" />
                                                <rect x="172.144" y="73.3006" width="100" height="45.4545" rx="10.9091"
                                                    transform="rotate(-12.1032 172.144 73.3006)" fill="#8B181B" />
                                                <rect x="171" y="67.9673" width="100" height="45.4545" rx="10.9091"
                                                    transform="rotate(-12.1032 171 67.9673)" fill="#AE1E22" />
                                                <path
                                                ...
                                                <path
                                                    ...
                                                    fill="#F2CBA8" />
                                                <mask id="mask1_898_7325" style="mask-type:alpha"
                                                    maskUnits="userSpaceOnUse" x="267" y="51" width="43" height="26">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <InputTextArea id="19" title="Catatan Penolakan" class="mt-4" />
                                </template>
                                <template v-slot:footer>
                                    <div class="row w-100">
                                        <div class="col-xl-6 col-12">
                ...
                <div class="col-lg-6 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <InputDatePicker />
                            <InputSmallText id="143" title="Test Judul"
                                icon="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/WhatsApp_icon.png/640px-WhatsApp_icon.png"
                                iconLabel="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/WhatsApp_icon.png/640px-WhatsApp_icon.png"
                                iconRight="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/WhatsApp_icon.png/640px-WhatsApp_icon.png"
                                type="date" required="" />
                ...
                <div class="col-lg-6 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <DataTable :data="tableDatas" :columns="tableColumnss" leftContent="name" rightContent="city">
                                <template v-slot:tableActionButtons="{ item }">
                                    <div class="d-flex">
                                        <Button class="w-100" type="neutral" size="sm" label="Edit" @click="handleEditAction(item)"/>
                                        <Button class="w-100" type="secondary" size="sm" label="Delete" @click="handleViewAction(item)"/>
                                    </div>
                                </template>
                            </DataTable>
                        </div>
        ...
        data() {
            return {
                ...
                tableData: [
                    ...
                    { id: 3, name: "Jane Doe", age: 25, ages: 123, agess: 123 },
                    { id: 4, name: "Jane Doe", age: 25, ages: 123, agess: 123 },
                    { id: 5, name: "Jane Doe", age: 25, ages: 123, agess: 123 },
                    { id: 6, name: "Jane Doe", age: 25, ages: 123, agess: 123 },
                    { id: 7, name: "Jane Doe", age: 25, ages: 123, agess: 123 },
                ],
                tableColumns: [
                    { key: "id", label: "ID", isAction: false },
                    { key: "name", label: "Name", isAction: false },
                    { key: "age", label: "Age", isAction: false },
                    { key: "ages", label: "Ages", isAction: false },
                    { key: "agess", label: "Agess", isAction: false },
                    {
                        key: "actions",
                        label: "Actions",
                        isAction: true,
                        showAction: true,
                        actions: [
                            { name: "view", label: "View", type:"neutral", size:"sm" },
                            { name: "edit", label: "Edit", type:"outline-primary", size:"sm" },
                        ],
                    },
                ],
                tableDatas: [
                    { id: 1, name: 'John Doe', city: 'New York', occupation: 'Software Engineer', salary: 80000 },
                    { id: 2, name: 'Jane Smith', city: 'Angeles', occupation: 'Data Scientist', salary: 95000 },
                    { id: 3, name: 'Bob Johnson', city: 'Chicago', occupation: 'Graphic Designer', salary: 60000 },
                    { id: 4, name: 'Alice Williams', city: 'Francisco', occupation: 'UX Designer', salary: 85000 },
                    { id: 5, name: 'Charlie Brown', city: 'Seattle', occupation: 'Marketing Manager', salary: 90000 },
                    { id: 6, name: 'Eva Davis', city: 'Miami', occupation: 'Financial Analyst', salary: 75000 },
                    { id: 7, name: 'Daniel Miller', city: 'Denver', occupation: 'Product Manager', salary: 100000 },
                    { id: 8, name: 'Grace Wilson', city: 'Austin', occupation: 'HR Specialist', salary: 70000 },
                    { id: 9, name: 'Henry Jackson', city: 'Boston', occupation: 'Business Analyst', salary: 82000 },
                    { id: 10, name: 'Isabel White', city: 'Portland', occupation: 'Project Coordinator', salary: 65000 },
                    { id: 41, name: 'Oliver Lee', city: 'San Diego', occupation: 'Software Developer', salary: 85000 },
                    { id: 42, name: 'Sophia Hall', city: 'Phoenix', occupation: 'Data Engineer', salary: 92000 },
                    { id: 43, name: 'Liam Turner', city: 'Dallas', occupation: 'UX/UI Designer', salary: 78000 },
                    { id: 44, name: 'Mia Foster', city: 'Houston', occupation: 'Sales Manager', salary: 88000 },
                    { id: 45, name: 'Lucas Murphy', city: 'Philadelphia', occupation: 'QA Engineer', salary: 80000 },
                    { id: 46, name: 'Ava Wright', city: 'Detroit', occupation: 'Marketing Specialist', salary: 76000 },
                    { id: 47, name: 'Jackson Evans', city: 'Nashville', occupation: 'Financial Analyst', salary: 84000 },
                    { id: 48, name: 'Ella Simmons', city: 'Memphis', occupation: 'Project Manager', salary: 93000 },
                    { id: 49, name: 'Logan Clark', city: 'Baltimore', occupation: 'IT Consultant', salary: 98000 },
                    { id: 50, name: 'Aria Allen', city: 'Charlotte', occupation: 'Product Designer', salary: 90000 },
                ],
                tableColumnss: [
                    { data: 'id', title: 'ID' },
