            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card overflow-x-auto p-3 mt-4">
                                <TableData :data="tableData" :columns="tableColumns" @row-click="handleRowClick"
                                    @action-click:view="handleViewAction" @action-click:edit="handleEditAction" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <DataTable :data="tableDatas" :columns="tableColumnss" leftContent="name"
                                rightContent="city">
                                <template v-slot:tableActionButtons="{ item }">
                                    <div class="d-flex">
                                        <Button class="w-100" type="neutral" size="sm" label="Edit"
                                            @click="handleEditAction(item)" />
                                        <Button class="w-100" type="secondary" size="sm" label="Delete"
