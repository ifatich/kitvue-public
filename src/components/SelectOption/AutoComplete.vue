<template>
    <div class="group-input">
        ...
        <Select2 v-model="currentValue" :options="items" :value-field="itemValue" v-bind="$attrs"
            :placeholder="placeholder" class="desktop" />

        <div class="mobile">
            <BButton @click.prevent="click" v-model="currentValue"
                class="w-100 btn-neutral gkit-dd d-flex justify-content-between align-items-center" :placeholder="placeholder">
            ...
            <BOffcanvas v-model="show" :no-close-on-backdrop="false" :placement="placement" class="w-100">
